...
<body class="flex h-screen text-gray-800 font-sans" style="background-color: #FAF5EE;">
  ...
  <div class="flex-1 flex flex-col overflow-hidden">
    ...
    <header class="px-6 py-2 flex justify-between items-center shadow md:pl-6" style="background-color: #1D503A; color: #FAF5EE;">
      ...
      <div x-data="{ open: false, showProfileModal: false, showInboxModal: false }" class="relative flex items-center space-x-3">

        <!-- Profile Image -->
        <img src="../uploads/<?php echo htmlspecialchars($imagePath); ?>" alt="Profile"
          class="w-10 h-10 rounded-full border-2 border-white shadow object-cover hover:scale-110 transition duration-300 ease-in-out" />
        ...
        <div class="relative">
          ...
          <button @click="open = !open"
            class="w-10 h-10 rounded-full bg-green-600 text-white flex items-center justify-center hover:bg-green-700 focus:outline-none">
          ...
          <!-- Dropdown Menu (Positioned Below Icon) -->
          <div
            x-show="open"
            @click.away="open = false"
            x-transition
            class="absolute right-0 mt-2 w-44 bg-white border rounded shadow text-gray-800 z-50">
            ...
            <!-- Inbox -->
            <button @click="showInboxModal = true; open = false"
              class="w-full text-left px-4 py-2 text-sm hover:bg-gray-100 flex items-center gap-2">
              <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" stroke-width="2"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
          ...
          <div
            ...
            class="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center px-4 overflow-auto">
            <div
              @click.away="showInboxModal = false"
              class="rounded-2xl shadow-2xl w-full max-w-lg relative p-6"
              style="background-color: #FFFFFF; color: #1D503A;">
              <button
